...
dataset <- dataset %>%
  mutate(
    day_weekname = as.factor(day_weekname),
    day = as.factor(day),
    lgt_condname = as.factor(lgt_condname),
    rur_urbname = as.factor(rur_urbname),
    day_weekname = as.factor(day_weekname),
    countyname = as.factor(countyname),
    statename = as.factor(statename),
    func_sysname = as.factor(func_sysname),
    hour = as.factor(hour)
  )
